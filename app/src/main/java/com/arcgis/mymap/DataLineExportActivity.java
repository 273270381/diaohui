...
public class DataLineExportActivity extends Activity {
    private ListView lv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            list=dataLineActivity.getData(list,cursor);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        list2.addAll(list);
        adapter=new ExportLineAdapter(list,DataLineExportActivity.this,R.layout.exportitem);
        lv.setAdapter(adapter);
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // 取得ViewHolder对象，这样就省去了通过层层的findViewById去实例化我们需要的cb实例的步骤
                ExportLineAdapter.Viewholder holder= (ExportLineAdapter.Viewholder) view.getTag();
                // 改变CheckBox的状态
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(DataLineExportActivity.this,db,dbHelper,projects);
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Newlines"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(DataLineExportActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            ExprotLineUtils.writelineExcel(DataLineExportActivity.this,listExport,filename,path);
                                            ToastNotRepeat.show(DataLineExportActivity.this,"导出成功！");
                                        }catch(Exception e){
                                            e.printStackTrace();
                                        }
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(DataLineExportActivity.this)
                                                .setTitle(" 选择坐标系统：")
                    ...
                    exportpath.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent f=new Intent(DataLineExportActivity.this,FileChooserActivity.class);
