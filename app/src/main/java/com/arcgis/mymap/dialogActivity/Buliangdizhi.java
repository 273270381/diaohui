...
public class Buliangdizhi extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buliangdizhi);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.lxBt:
                initJsonData(Buliangdizhi.this,"buliangdizhi.json");
                setpvOptions("类型",bt1,options1Items);
                break;
            case R.id.msBt:
                VoiceToText.startSpeechDialog(Buliangdizhi.this,et1);
                break;
            case R.id.cancel:
                finish();
                break;
    ...
    public void setpvOptions(String text, final Button bt, final ArrayList<JsonBean> options1Items , final ArrayList<ArrayList<String>> options2Items, final ArrayList<ArrayList<ArrayList<String>>> options3Items ){
        OptionsPickerView pvOptions = new OptionsPickerBuilder(Buliangdizhi.this, new OnOptionsSelectListener() {
            @Override
