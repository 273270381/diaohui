...
public class Shuiwendizhi extends Activity implements View.OnClickListener{
    private Button bt;
    private Button bt1,bt2,bt3,bt4,bt5,bt6,cancel,sure;
    private EditText et1,et2,et3,et4,et5,et6,et;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shuiwendizhidian);
        getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        initView();
    }
    private void initView() {
        bt = (Button) findViewById(R.id.sllxbt);
        bt1 = (Button) findViewById(R.id.smkdBt);
        bt2 = (Button) findViewById(R.id.ssBt);
        bt3 = (Button) findViewById(R.id.lsBt);
        bt4 = (Button) findViewById(R.id.llBt);
        bt5 = (Button) findViewById(R.id.szBt);
        bt6 = (Button) findViewById(R.id.msBt);
        et1 = (EditText) findViewById(R.id.smkdEt);
        et2 = (EditText) findViewById(R.id.ssEt);
        et3 = (EditText) findViewById(R.id.lsEt);
        et4 = (EditText) findViewById(R.id.llEt);
        et5 = (EditText) findViewById(R.id.szEt);
        et6 = (EditText) findViewById(R.id.msEt);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.sllxbt:
                initJsonData(Shuiwendizhi.this,"shuiliuleixing.json");
                setpvOptions("地质信息",bt,options1Items);
                break;
            case R.id.smkdBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et1);
                break;
            case R.id.ssBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et2);
                break;
            case R.id.lsBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et3);
                break;
            case R.id.llBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et4);
                break;
            case R.id.szBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et5);
                break;
            case R.id.msBt:
                VoiceToText.startSpeechDialog(Shuiwendizhi.this,et6);
                break;
            case R.id.sure:
                Intent intent = new Intent();
                intent.putExtra("name",et.getText().toString());
                intent.putExtra("sllx",bt.getText().toString());
                intent.putExtra("smkd",et1.getText().toString());
                intent.putExtra("ss",et2.getText().toString());
                intent.putExtra("ls",et3.getText().toString());
                intent.putExtra("ll",et4.getText().toString());
                intent.putExtra("sz",et5.getText().toString());
                intent.putExtra("ms",et6.getText().toString());
    ...
    public void setpvOptions(String text, final Button bt, final ArrayList<JsonBean> options1Items , final ArrayList<ArrayList<String>> options2Items, final ArrayList<ArrayList<ArrayList<String>>> options3Items ){
        OptionsPickerView pvOptions = new OptionsPickerBuilder(Shuiwendizhi.this, new OnOptionsSelectListener() {
            @Override
