...
public class Teshuxingtu extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teshuxingtu);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.lxBt:
                initJsonData(Teshuxingtu.this,"teshuxingtu.json");
                setpvOptions("类型",bt1,options1Items);
                break;
            case R.id.msBt:
                VoiceToText.startSpeechDialog(Teshuxingtu.this,et1);
                break;
            case R.id.cancel:
                finish();
                break;
    ...
    public void setpvOptions(String text, final Button bt, final ArrayList<JsonBean> options1Items , final ArrayList<ArrayList<String>> options2Items, final ArrayList<ArrayList<ArrayList<String>>> options3Items ){
        OptionsPickerView pvOptions = new OptionsPickerBuilder(Teshuxingtu.this, new OnOptionsSelectListener() {
            @Override
