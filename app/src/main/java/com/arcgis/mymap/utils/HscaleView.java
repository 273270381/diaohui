 ...
 */
public class HscaleView extends View {
    ...
    public HscaleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HscaleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try{
            canvas.save();
            String tr="";
            canvas.drawText(tr,centerX+20,190,kmTextPaint);
            for (int i=min;i<max;i++){
                if (i%10==0){
                    canvas.drawLine(centerX,centerY,centerX+44,centerY,mLinePaint);
                    ...
                    if (i!=0){
                        canvas.drawText(t,centerX-txtWidth-10,centerY+rect.height()/2,mTextPaint);
                    }
                }else if(i%5==0){
                    canvas.drawLine(centerX,centerY,centerX+28,centerY,mLinePaint);
                }else {
                    canvas.drawLine(centerX,centerY,centerX+12,centerY,mLinePaint);
                }
