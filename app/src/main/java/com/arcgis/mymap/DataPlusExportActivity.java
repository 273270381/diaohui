 ...
 */
public class DataPlusExportActivity extends Activity {
    private ListView lv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list2.addAll(list);
        mAdapter=new ExportAdatper(list,R.layout.exportitem,DataPlusExportActivity.this);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(DataPlusExportActivity.this,db,dbHelper,projects);
    }
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Pointexcel"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(DataPlusExportActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            ExprotUtils.writeExcel(DataPlusExportActivity.this,listExport,filename,path);
                                            ToastNotRepeat.show(DataPlusExportActivity.this,"导出成功！");
                                        }catch(Exception e){
                                            e.printStackTrace();
                                        }
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(DataPlusExportActivity.this)
                                                .setTitle(" 选择坐标系统：")
                    ...
                    exportpath.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent f=new Intent(DataPlusExportActivity.this,FileChooserActivity.class);
