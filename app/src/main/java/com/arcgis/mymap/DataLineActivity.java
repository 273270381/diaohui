...
public class DataLineActivity extends Activity {
    TextView left_title;
    ...
    private void findbyid() throws ParseException {
        ...
        pposition=getTable.getTableposition(DataLineActivity.this,db,dbHelper,projects);
    ...
    private void initTableView() throws ParseException {
        ...
        Cursor cursor = db.query("Newlines"+pposition, null, null, null, null, null, null);
        linesList=getData(linesList, cursor);
        resource=R.layout.table_left_item;
        resource2=R.layout.table_right_item_line;
        leftlineAdapter=new LeftListLineAdapter(linesList,resource,DataLineActivity.this);
        rightLineAdapter=new RightLineAdapter(linesList,resource2,DataLineActivity.this);
    ...
    private class LongClicklistener implements View.OnLongClickListener{
        ...
        public boolean onLongClick(View v) {
            AlertDialog dialog = new AlertDialog.Builder(DataLineActivity.this).setTitle("警告：")
                    .setMessage("是否删除全部数据？")
                    ...
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //清空lines表
                            Cursor cursor1=db.query("Newlines"+pposition,null,null,null,null,null,null);
                            ...
                            for (int i=0;i<listLa.size();i++){
                                db.delete("Newlines"+pposition, "xla=?", new String[]{listLa.get(i)});
                            }
                            ...
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    leftlineAdapter=new LeftListLineAdapter(finallinelist,resource,DataLineActivity.this);
                                    rightLineAdapter=new RightLineAdapter(finallinelist,resource2,DataLineActivity.this);
                                    leftlistView.setAdapter(leftlineAdapter);
                                    rightlistView.setAdapter(rightLineAdapter);
                                    ToastNotRepeat.show(DataLineActivity.this,"删除成功");
                                }
                            },400);
                            Intent a=new Intent();
    ...
    private class ClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch(v.getId()){
                ...
                break;
                case R.id.bt5:
                    Intent i=new Intent(DataLineActivity.this,MainActivity.class);
                ...
                case R.id.bt1:
                    if (b){
                        ...
                        AlertDialog dialog1 = new AlertDialog.Builder(DataLineActivity.this)
                                .setTitle("详细：")
                ...
                case R.id.bt2:
                    if (b){
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(DataLineActivity.this)
                                .setTitle("数据编辑：")
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        db.update("Newlines"+pposition, values, "id=?", new String[]{String.valueOf(id)});
                                        ...
                                        new Handler().postDelayed(new Runnable() {
                                            ...
                                            public void run() {
                                                rightLineAdapter.notifyDataSetChanged();
                                                ToastNotRepeat.show(DataLineActivity.this,"保存成功");
                                            }
                                        }, 400);
                                        Intent a=new Intent();
                                        a.setAction("com.delatedatas.broadcast");
                    ...
                    if (b){
                        AlertDialog dialog = new AlertDialog.Builder(DataLineActivity.this)
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        b = false;
                                        db.delete("Newlines"+pposition, "id=?", new String[]{String.valueOf(id)});
                                        linesList.remove(p);
                                        new Handler().postDelayed(new Runnable() {
                                            @Override
                                            public void run() {
                ...
                case R.id.search:
                    ...
                    if (TextUtils.isEmpty(text.getText())) {
                        ...
                        Cursor cursor2 = db.query("Newlines"+pposition, null, "classification like ?", new String[]{ "%" + tsname + "%" }, null, null, null);
                        try {
                        ...
                        if (linesList.size() == 0) {
                            ToastNotRepeat.show(DataLineActivity.this, "抱歉，没有找到你要的数据！");
                        }
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
