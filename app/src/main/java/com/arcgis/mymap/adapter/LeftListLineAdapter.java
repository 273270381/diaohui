 ...
 */
public class LeftListLineAdapter extends BaseAdapter {
    private List<MoreLines> linesList;
    private int resourse;
    private Context context;
    public static int  selectItem=-1;

    public LeftListLineAdapter(List<MoreLines> linesList, int resourse, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvnum.setText(String.valueOf(line.getId()));
