...
public class GeoExportLineAdapter extends BaseAdapter{
    // 填充数据的list
    ...
    public GeoExportLineAdapter(List<MoreLines> list, Context context, int resourse) {
        this.list = list;
    ...
    public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
        GeoExportLineAdapter.isSelected = isSelected;
    }
