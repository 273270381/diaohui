...
public class ComBoxLineAdapter extends BaseAdapter {
    private List<MoreLines> lineList;
    ...
    public ComBoxLineAdapter(List<MoreLines> lineList, int resourse, Context context) {
