 ...
 */
public class RightlistAdapter3 extends BaseAdapter{
    private List<LitepalPoints> pointsList;
    private int resourse;
    private Context context;
    public static int  selectItem=-1;

    public RightlistAdapter3(List<LitepalPoints> pointsList, int resourse, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            holder.name= (TextView) convertView.findViewById(R.id.tv_table_content_right_item4);
