...
public class GeoDcyxCass {
    public void creatWgs84(String filename, List<DicengyanxingPoint> list){
    ...
    public void createbeijing54(String filename, List<DicengyanxingPoint> list){
        String path=createFile(filename);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
    ...
    public void createxian80(String filename,List<DicengyanxingPoint> list){
        String path=createFile(filename);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
    ...
    public void createguojia2000(String filename,List<DicengyanxingPoint> list){
        String path=createFile(filename);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
