...
public class GeoSwdzCass {
    public void create(String filename, List<ShuiwendizhiPoint> list,String exportpath){
        ...
        try {
            ...
            for (int i=0;i<list.size();i++){
                ...
                String context = "";
                if (list.get(i).getSllx().equals("地质时代")){
    ...
    public void creatWgs84(String filename, List<ShuiwendizhiPoint> list,String exportpath){
        String path=createFile(filename,exportpath);
        try {
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
    ...
    public void createbeijing54(String filename, List<ShuiwendizhiPoint> list,String exportpath){
        String path=createFile(filename,exportpath);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
    ...
    public void createxian80(String filename,List<ShuiwendizhiPoint> list,String exportpath){
        String path=createFile(filename,exportpath);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
    ...
    public void createguojia2000(String filename,List<ShuiwendizhiPoint> list,String exportpath){
        String path=createFile(filename,exportpath);
        try{
            OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(path), "GB2312");
            for (int i=0;i<list.size();i++){
