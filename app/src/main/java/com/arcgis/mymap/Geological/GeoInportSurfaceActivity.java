...
public class GeoInportSurfaceActivity extends Activity {
    TextView left_title;
    ...
    private void findbyid() throws ParseException {
        ...
        pposition=getTable.getTableposition(GeoInportSurfaceActivity.this,db,dbHelper,projects);
    ...
    private void initTableView() throws ParseException {
        ...
        leftlineAdapter=new GeoLeftSurfaceAdapter(surFaces,resource,GeoInportSurfaceActivity.this);
        rightLineAdapter=new GeoRightSurfaceAdapter(surFaces,resource2,GeoInportSurfaceActivity.this);
        comBoxAdapter = new ComBoxSurfaceAdapter(surFaces,resource3,GeoInportSurfaceActivity.this);
    ...
    private class LongClicklistener implements View.OnLongClickListener{
        ...
        public boolean onLongClick(View v) {
            AlertDialog dialog = new AlertDialog.Builder(GeoInportSurfaceActivity.this).setTitle("警告：")
                    .setMessage("是否删除全部数据？")
                    ...
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //清空lines表
                            Cursor cursor1=db.query("Geosurfaceexcel"+pposition,null,null,null,null,null,null);
                            ...
                            for (int i=0;i<listLa.size();i++){
                                db.delete("Geosurfaceexcel"+pposition, "gla=?", new String[]{listLa.get(i)});
                            }
                            ...
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    leftlineAdapter=new GeoLeftSurfaceAdapter(finallinelist,resource,GeoInportSurfaceActivity.this);
                                    rightLineAdapter=new GeoRightSurfaceAdapter(finallinelist,resource2,GeoInportSurfaceActivity.this);
                                    leftlistView.setAdapter(leftlineAdapter);
                                    rightlistView.setAdapter(rightLineAdapter);
                                    ToastNotRepeat.show(GeoInportSurfaceActivity.this,"删除成功");
                                }
                            },400);
                            Intent a=new Intent();
        ...
        public void onClick(View v) {
            switch(v.getId()){
                case R.id.back:
                    ...
                    break;
                case R.id.bt5:
                    Intent i=new Intent(GeoInportSurfaceActivity.this,GeologicalMapActivity.class);
                ...
                case R.id.bt1:
                    if (b){
                        ...
                        AlertDialog dialog1 = new AlertDialog.Builder(GeoInportSurfaceActivity.this)
                                .setTitle("详细：")
                ...
                case R.id.bt2:
                    if (b){
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(GeoInportSurfaceActivity.this)
                                .setTitle("数据编辑：")
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        db.update("Geosurfaceexcel"+pposition, values, "id=?", new String[]{String.valueOf(id)});
                                        ...
                                        new Handler().postDelayed(new Runnable() {
                                            ...
                                            public void run() {
                                                rightLineAdapter.notifyDataSetChanged();
                                                ToastNotRepeat.show(GeoInportSurfaceActivity.this,"保存成功");
                                            }
                                        }, 400);
                                        Intent a=new Intent();
                                        a.setAction("com.delatedatas.broadcast");
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        for(int  i =0 ; i<surFaceExport.size() ; i++){
                                            db.delete("Geosurfaceexcel"+pposition, "id=?", new String[]{String.valueOf(surFaceExport.get(i).getId())});
                ...
                case R.id.search:
                    ...
                    if (TextUtils.isEmpty(text.getText())) {
                        ...
                        Cursor cursor2 = db.query("Geosurfaceexcel"+pposition, null, "gclassification like ?", new String[]{ "%" + tsname + "%" }, null, null, null);
                        try {
                        ...
                        if (surFaces.size() == 0) {
                            ToastNotRepeat.show(GeoInportSurfaceActivity.this, "抱歉，没有找到你要的数据！");
                        }
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
