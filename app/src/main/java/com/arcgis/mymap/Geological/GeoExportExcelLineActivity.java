...
public class GeoExportExcelLineActivity extends Activity{
    private ListView lv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list2.addAll(list);
        adapter=new GeoExportLineAdapter(list,GeoExportExcelLineActivity.this,R.layout.exportitem);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(GeoExportExcelLineActivity.this,db,dbHelper,projects);
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Geomorelineexcel"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(GeoExportExcelLineActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(GeoExportExcelLineActivity.this)
                                                .setTitle(" 选择坐标系统：")
