...
public class GeoPhotoExportActivity extends Activity{
    private ListView lv;
    ...
    private GeoPhotoActivity geoPhotoActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            list=geoPhotoActivity.getData(list,cursor);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        list2.addAll(list);
        mAdapter=new ExportAdatper(list,R.layout.exportitem,GeoPhotoExportActivity.this);
    ...
    private void intview() {
        geoPhotoActivity = new GeoPhotoActivity();
        ...
        pposition=getTable.getTableposition(GeoPhotoExportActivity.this,db,dbHelper,projects);
    }
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Geophotopoints"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(GeoPhotoExportActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            GeoExportUtils.writeExcel(GeoPhotoExportActivity.this,listExport,filename);
                                            ToastNotRepeat.show(GeoPhotoExportActivity.this,"导出成功！");
                                        }catch(Exception e){
                                            e.printStackTrace();
                                        }
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(GeoPhotoExportActivity.this)
                                                .setTitle(" 选择坐标系统：")
