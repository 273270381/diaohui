...
public class GeoDataLineActivity extends Activity{
    TextView left_title;
    ...
    private void findbyid() throws ParseException {
        ...
        pposition=getTable.getTableposition(GeoDataLineActivity.this,db,dbHelper,projects);
    ...
    private void initTableView() throws ParseException {
        ...
        leftlineAdapter=new GeoLeftListLineAdapter(linesList,resource,GeoDataLineActivity.this);
        rightLineAdapter=new GeoRightLineAdapter(linesList,resource2,GeoDataLineActivity.this);
        comBoxLineAdapter = new ComBoxLineAdapter(linesList,resource3,GeoDataLineActivity.this);
    ...
    private class LongClicklistener implements View.OnLongClickListener{
        ...
        public boolean onLongClick(View v) {
            AlertDialog dialog = new AlertDialog.Builder(GeoDataLineActivity.this).setTitle("警告：")
                    .setMessage("是否删除全部数据？")
                    ...
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //清空lines表
                            Cursor cursor1=db.query("Geomorelines"+pposition,null,null,null,null,null,null);
        ...
        public void onClick(View v) {
            switch(v.getId()){
                case R.id.back:
                    ...
                    break;
                case R.id.bt5:
                    Intent i=new Intent(GeoDataLineActivity.this,GeologicalMapActivity.class);
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog3=new AlertDialog.Builder(GeoDataLineActivity.this)
                            .setTitle("导出数据:")
                ...
                case R.id.bt2:
                    if (b){
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(GeoDataLineActivity.this)
                                .setTitle("数据编辑：")
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        for(int i =0;i<lineExport.size();i++){
                                            db.delete("Geomorelines"+pposition, "id=?", new String[]{String.valueOf(lineExport.get(i).getId())});
                ...
                case R.id.search:
                    ...
                    if (TextUtils.isEmpty(text.getText())) {
                        ...
                        Cursor cursor2 = db.query("Geomorelines"+pposition, null, "gclassification like ?", new String[]{ "%" + tsname + "%" }, null, null, null);
                        try {
                        ...
                        if (linesList.size() == 0) {
                            ToastNotRepeat.show(GeoDataLineActivity.this, "抱歉，没有找到你要的数据！");
                        }
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
