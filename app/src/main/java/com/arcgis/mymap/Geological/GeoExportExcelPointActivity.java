...
public class GeoExportExcelPointActivity extends Activity{
    private ListView lv;
    ...
    private GeoDataPointActivity geoDataPointActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            list=geoDataPointActivity.getData(list,cursor);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        list2.addAll(list);
        mAdapter=new ExportAdatper(list,R.layout.exportitem,GeoExportExcelPointActivity.this);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(GeoExportExcelPointActivity.this,db,dbHelper,projects);
    }
    //为按钮添加监听
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Geopointexcel"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(GeoExportExcelPointActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            GeoExportUtils.writeExcel(GeoExportExcelPointActivity.this,listExport,filename);
                                            ToastNotRepeat.show(GeoExportExcelPointActivity.this,"导出成功！");
                                        }catch(Exception e){
                                            e.printStackTrace();
                                        }
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(GeoExportExcelPointActivity.this)
                                                .setTitle(" 选择坐标系统：")
