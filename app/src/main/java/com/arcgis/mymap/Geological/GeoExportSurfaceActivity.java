...
public class GeoExportSurfaceActivity extends Activity{
    private ListView lv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list2.addAll(list);
        adapter=new GeoExportSurfaceAdapter(list,GeoExportSurfaceActivity.this,R.layout.exportitem);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(GeoExportSurfaceActivity.this,db,dbHelper,projects);
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Geosurface"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(GeoExportSurfaceActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            //GeoExportSurfaceUtils.writesurfaceExcel(GeoExportSurfaceActivity.this,listExport,filename);
                                            ToastNotRepeat.show(GeoExportSurfaceActivity.this,"导出成功！");
                                        }catch(Exception e){
                                            e.printStackTrace();
                                        }
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(GeoExportSurfaceActivity.this)
                                                .setTitle(" 选择坐标系统：")
