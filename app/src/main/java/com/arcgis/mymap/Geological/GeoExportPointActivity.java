...
public class GeoExportPointActivity extends Activity{
    private ListView lv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list2.addAll(list);
        mAdapter=new ExportAdatper(list,R.layout.exportitem,GeoExportPointActivity.this);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(GeoExportPointActivity.this,db,dbHelper,projects);
    }
    //为按钮添加监听
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Geopoints"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(GeoExportPointActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        try{
                                            GeoExportUtils.writeExcel(GeoExportPointActivity.this,listExport,filename);
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(GeoExportPointActivity.this)
                                                .setTitle(" 选择坐标系统：")
