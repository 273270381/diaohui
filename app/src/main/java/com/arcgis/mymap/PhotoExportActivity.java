...
public class PhotoExportActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list2.addAll(list);
        mAdapter=new ExportAdatper(list,R.layout.exportitem,PhotoExportActivity.this);
    ...
    private void intview() {
        ...
        pposition=getTable.getTableposition(PhotoExportActivity.this,db,dbHelper,projects);
    }
            ...
            switch(v.getId()){
                case R.id.delate:
                    for (int x=0;x<listExport.size();x++){
                        db.delete("Photopoints"+pposition, "id=?", new String[]{String.valueOf(listExport.get(x).getId())});
                ...
                case R.id.export:
                    ...
                    AlertDialog dialog=new AlertDialog.Builder(PhotoExportActivity.this)
                            .setTitle("导出数据:")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (bt4.isChecked()){
                                        ...
                                        AlertDialog dialog1=new AlertDialog.Builder(PhotoExportActivity.this)
                                                .setTitle(" 选择坐标系统：")
